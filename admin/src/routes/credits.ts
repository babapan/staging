...
router.post("/transfer-all", requireSuperAdmin, async (req, res) => {
...
router.get("/balance/:username", requireAdmin, async (req, res) => {
...
router.post("/deduct", requireSuperAdmin, async (req, res) => {
...
router.get("/user-history/:username", requireAdmin, async (req, res) => {
  const { username } = req.params;
